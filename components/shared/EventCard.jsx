  ...
  const handleShare = () => {
    if (navigator.share) {
      ...
      navigator
        .share({
          title: event.title,
          text: `${event.title} on ${formatDateTimeForSharing(event.startDateTime).dateWithoutYear} at ${event.location}. This link helps you set a reminder easily 👉🏽`,
                ...
                <div>
                  <div className="flex flex-col gap-8">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="text-sm">
                          ...
                          <p className="text-gray-600">
                            ...
                            -{" "}
                            {
                              formatDateTimeForSharing(event.endDateTime)
                                .timeOnly
                            }
                          </p>
                        </div>
                    ...
                    {isOwner && (
                      <Button
                        onClick={() =>
                          router.push(`/e/${event.publicId}/update`)
                        }
